		...
		<section class="order-primary">
			...
			<table class="orders-table">
				...
				if ( ! $taxes['error'] && $taxes['data']['name'] ) {
					$price = $order->get_price( 'total', [], 'float' );
					...
					?>
					<tr>
						<th class="llms-label"><?php echo "{$taxes['data']['name']} $rate%"; ?></th>
						<td><?php echo $tax; ?></td>
					</tr>
					<tr>
						<th class="llms-label"><?php _e( 'Net Price', 'lifterlms' ); ?></th>
						<td><?php echo llms_price( $net_price ) . " (-$tax)" ?></td>
					</tr>
					<?php
				}
				?>
